 ...
 */
package org.activiti.cloud.services.graphql.ws.datafetcher;
...
public class StompRelayObservablePublisherFactory implements StompRelayPublisherFactory {

    private static Logger log = LoggerFactory.getLogger(StompRelayObservablePublisherFactory.class);
    ...
    public StompRelayObservablePublisherFactory(ReactorNettyTcpStompClient stompClient) {
    ...
    public StompRelayObservablePublisherFactory login(String login) {
        this.login = login;
    ...
    public StompRelayObservablePublisherFactory passcode(String passcode) {
     ...
     */
    public StompRelayObservablePublisherFactory destinationResolver(StompRelayDestinationResolver destinationResolver) {
