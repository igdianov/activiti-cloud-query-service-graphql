...
public class ConsumerMessageHandler {
    ...
    private static Logger logger = LoggerFactory.getLogger(ConsumerMessageHandler.class);
    private static ObjectMapper objectMapper = new ObjectMapper();

    private final FluxSink<Message<EngineEvent>> processorSink;
    private final Transformer transformer;
    
    public ConsumerMessageHandler(Transformer transformer,
    ...
    @StreamListener
    public void receive(@Input(ConsumerChannels.NOTIFICATIONS_CONSUMER) 
